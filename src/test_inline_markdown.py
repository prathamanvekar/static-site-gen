...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_multiple_images(self):
        matches = extract_markdown_images(
            "Images: ![img1](https://a.com/1.png) and ![img2](https://b.com/2.jpg)"
        )
        self.assertListEqual(
            [
                ("img1", "https://a.com/1.png"),
    ...
    def test_extract_image_with_text_around(self):
        matches = extract_markdown_images(
            "Start ![logo](https://site.com/logo.svg) end"
        )
        self.assertListEqual(
            [("logo", "https://site.com/logo.svg")],
            matches
        )
    ...
    def test_extract_no_links(self):
        matches = extract_markdown_links(
            "No markdown links in this sentence."
        )
        self.assertListEqual([], matches)
    
    
    def test_extract_images_and_links_together(self):
        image_matches = extract_markdown_images(
            "![img](https://img.com/a.png) and a [link](https://site.com)"
        )
